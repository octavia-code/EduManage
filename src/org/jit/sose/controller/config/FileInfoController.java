...
public class FileInfoController {
	...
	public static void uploadFile(File file, String uploadPath) {
		// File file = new
		// File("D://Java//IntelliJIDEA//workspace//J2SE//IO//file//fileBuffered//bufferedStream.txt");//
		// 文件对象

		// String path =
		// "D://Java//IntelliJIDEA//workspace//J2SE//IO//file//fileBuffered//copy//bufferedStream.txt";//
		// 目标路径
	...
	public PageInfo<FileInfo> selectPageInfo(@RequestBody String str) {
		// 使用fastjson转为json对象
		JSONObject strj = JSON.parseObject(str);
		FileInfo fileInfo = new FileInfo();
		// 过滤查询条件
		String fileName = strj.getString("fileName");
		...
		return filesSerivce.selectVideoInfoList(fileInfo, pageNum, pageSize);
	}
